...
MODEL               = synchronous_generator_modeling
MODULES             = rt_matrx.c rt_printf.c rt_logging.c rtGetInf.c rtGetNaN.c rt_nonfinite.c synchronous_generator_modeling.c synchronous_generator_modeling_capi.c synchronous_generator_modeling_data.c synchronous_generator_modeling_tgtconn.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c sfun_spid_contc.c
MAKEFILE            = synchronous_generator_modeling.mk
MATLAB_ROOT         = D:/Tools/matlab
ALT_MATLAB_ROOT     = D:/Tools/matlab
MATLAB_BIN          = D:/Tools/matlab/bin
ALT_MATLAB_BIN      = D:/Tools/matlab/bin
MASTER_ANCHOR_DIR   = 
START_DIR           = D:/projects/Git
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/synchronous_generator_modeling \
...
%.obj : $(START_DIR)/slprj/raccel/synchronous_generator_modeling/%.c
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
...
rtiostream_utils.obj : D:\Tools\matlab\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Tools\matlab\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c

sfun_spid_contc.obj : D:\Tools\matlab\toolbox\physmod\powersys\powersys/sfun_spid_contc.c
	$(CC) -c -Fo$(@F) $(CFLAGS) D:\Tools\matlab\toolbox\physmod\powersys\powersys/sfun_spid_contc.c
...
%.obj : $(START_DIR)/slprj/raccel/synchronous_generator_modeling/%.cpp
	$(CC) -c -Fo$(@F) $(CFLAGS) $<
